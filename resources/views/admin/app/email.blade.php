...
@section('pagetitle', 'ADMIN | MAIL APP')
@section('main')
                            ...
                            <div class="table-responsive">
                                <table class="table c_table inbox_table">
                                    <tbody><tr>
                                        ...
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Maryam Amiri</h5></td>
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Hossein Shams</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                    ...
                                    <tr>
                                        ...
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Frank Camly</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Tim Hank</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                    ...
                                    <tr>
                                        ...
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Brielle Williamson</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                                <span class="badge badge-info mr-2">Marketing</span>
                                                It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. 
                                    ...
                                    <tr>
                                        ...
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Brenden Wagner</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                                <span class="badge badge-danger mr-2">Ui Project</span>
                                                There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected
                                    ...
                                    <tr>
                                        ...
                                        <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                                        <td class="u_image"><img src="assets/images/xs/avatar4.jpg" alt="user" class="rounded" width="30"></td>
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Angelica Ramos</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                                Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="starred"><a href="javascript:void(0);"><i class="zmdi zmdi-star"></i></a></td>
                                        <td class="u_image"><img src="assets/images/xs/avatar1.jpg" alt="user" class="rounded" width="30"></td>
                                        <td class="u_name"><h5 class="font-15 mt-0 mb-0">Ashton Cox</h5></td>
                                        <td class="max_ellipsis">
                                            <a class="link" href="mail-single.html">
                                                Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            </a>
