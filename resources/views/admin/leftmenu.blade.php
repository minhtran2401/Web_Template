<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <a href="{{asset('admin')}}" class="nav-link"><i data-feather="monitor"></i><span>Trang Chủ</span></a>
        </li>

        <li class="dropdown">
            <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Ứng Dụng Xịn Xò</span></a>
            <ul class="dropdown-menu">
            <li><a class="nav-link" href="{{asset('chatapp')}}">Chat</a></li>
           
            <li><a class="nav-link" href="{{asset('calendar')}}">Calendar</a></li>
            </ul>
          </li>
          <li class="dropdown">
        ...
        <li class="dropdown">
          <a href="#" class="menu-toggle nav-link has-dropdown"><i
              data-feather="briefcase"></i><span>Loại Temp</span></a>
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="{{route('temp_typeBE.index')}}">Danh Sách Loại Template </a></li>
          <li><a class="nav-link" href="{{route('temp_typeBE.create')}}">Thêm Loại Mới </a></li>
          </ul>
        </li>

        <li class="dropdown">
            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                data-feather="briefcase"></i><span>Template</span></a>
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="{{route('templateBE.index')}}">Danh Sách Template </a></li>
            <li><a class="nav-link" href="{{route('templateBE.create')}}">Thêm Template Mới </a></li>
            </ul>
          </li>
